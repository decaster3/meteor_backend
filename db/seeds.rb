...
City.create!([
                 {name: "Osaka", schedule: "{ \"opens_at\": \"8am\", \"closes_at\": \"11pm\"}", country_id: 1, currency: "KGS", phone: "58000000000"}
             ])
Category.create!([
                     {name: "Pizza"}
                 ])
...
Product.create!([
                    {name: "Margharita", description: "Ordinary margharita pizza with meat, tomatoes and cheese", category_id: 1, is_topping: false}
                ])
